...
from common.util import Packer

from simple.bus import Bus
from simple.reg import Reg, Port, Field, DummyField, RwField
...
class FrontPanel(object):
    ...
    def __init__(self, system, fp_rst, fp_clk, fp_din,
        ...
        self.ctl_reg = Reg(system, 'fp_ctl', "Frontpanel Control", [
            RwField('init', "Initialize frontpanel when true", self.fp_init),
            ])

        self.data_reg = Reg(system, 'fp_data', "Frontpanel Data", [
