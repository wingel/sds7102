...
0  B10 IO_L35P_GCLK17_0			ADC DI0 P
0  A10 IO_L35N_GCLK16_0			ADC DI0 N
...
0  C11 IO_L39P_0			ADC DI4 P (inverted)
0  A11 IO_L39N_0			ADC DI4 N (inverted)
0  F9  IO_L40P_0			ADC08D500 CS
0  D9  IO_L40N_0			SCK
0  B12 IO_L62P_0			ADC DI1 P
0  A12 IO_L62N_VREF_0			ADC DI1 N
0  C13 IO_L63P_SCP7_0			ADC DI2 P
0  A13 IO_L63N_SCP6_0			ADC DI2 N
0  F10 IO_L64P_SCP5_0			ADC DI6 P
0  E11 IO_L64N_SCP4_0			ADC DI6 N
0  B14 IO_L65P_SCP3_0			ADC DI3 P (inverted)
0  A14 IO_L65N_SCP2_0			ADC DI3 N (inverted)
0  D11 IO_L66P_SCP1_0			ADC DI5 P
0  D12 IO_L66N_SCP0_0			ADC DI5 N
NA C14 TCK
NA C12 TDI
NA A15 TMS
NA E14 TDO
1  E13 IO_L1P_A25_1			ADC DI7 P
1  E12 IO_L1N_A24_VREF_1		ADC DI7 N
1  B15 IO_L29P_A23_M1A13_1		ADC DId0 P
1  B16 IO_L29N_A22_M1A14_1		ADC DId0 N
1  F12 IO_L30P_A21_M1RESET_1		ADC DQ7 P (inverted)
1  G11 IO_L30N_A20_M1A11_1		ADC DQ7 N (inverted)
1  D14 IO_L31P_A19_M1CKE_1		ADC DId2 P (inverted)
1  D16 IO_L31N_A18_M1A12_1		ADC DId2 N (inverted)
1  F13 IO_L32P_A17_M1A8_1		ADC OVR_P
1  F14 IO_L32N_A16_M1A9_1		ADC OVR_N
1  C15 IO_L33P_A15_M1A10_1		ADC DId1 P
1  C16 IO_L33N_A14_M1A4_1		ADC DId1 N
1  E15 IO_L34P_A13_M1WE_1		ADC DId3 P
1  E16 IO_L34N_A12_M1BA2_1		ADC DId3 N
1  F15 IO_L35P_A11_M1A7_1		ADC DId4 P
1  F16 IO_L35N_A10_M1A2_1		ADC DId4 N
1  G14 IO_L36P_A9_M1BA0_1		ADC DId5 P
1  G16 IO_L36N_A8_M1BA1_1		ADC DId5 N
1  H15 IO_L37P_A7_M1A0_1		ADC DId6 P (inverted)
1  H16 IO_L37N_A6_M1A1_1		ADC DId6 N (inverted)
1  G12 IO_L38P_A5_M1CLK_1		ADC DQ5 P (inverted)
1  H11 IO_L38N_A4_M1CLKN_1		ADC DQ5 N (inverted)
1  H13 IO_L39P_M1A3_1			ADC DQ6 P
1  H14 IO_L39N_M1ODT_1			ADC DQ6 N
1  J11 IO_L40P_GCLK11_M1A5_1		ADC DQ3 P
1  J12 IO_L40N_GCLK10_M1A6_1		ADC DQ3 N
1  J13 IO_L41P_GCLK9_IRDY1_M1RASN_1	ADC DQ4 P
1  K14 IO_L41N_GCLK8_M1CASN_1		ADC DQ4 N
1  K12 IO_L42P_GCLK7_M1UDM_1		ADC DQ0 P
1  K11 IO_L42N_GCLK6_TRDY1_M1LDM_1	ADC DQ0 N
1  J14 IO_L43P_GCLK5_M1DQ4_1		ADC DId7 P
1  J16 IO_L43N_GCLK4_M1DQ5_1		ADC DId7 N
1  K15 IO_L44P_A3_M1DQ6_1		ADC DQd7 P
1  K16 IO_L44N_A2_M1DQ7_1		ADC DQd7 N
1  N14 IO_L45P_A1_M1LDQS_1		ADC DQd4 P (inverted)
1  N16 IO_L45N_A0_M1LDQSN_1		ADC DQd4 N (inverted)
1  M15 IO_L46P_FCS_B_M1DQ2_1		ADC DQd5 P
1  M16 IO_L46N_FOE_B_M1DQ3_1		ADC DQd5 N
1  L14 IO_L47P_FWE_B_M1DQ0_1		ADC DQd6 P (inverted)
1  L16 IO_L47N_LDC_M1DQ1_1		ADC DQd6 N (inverted)
1  P15 IO_L48P_HDC_M1DQ8_1		ADC DQd3 P
1  P16 IO_L48N_M1DQ9_1			ADC DQd3 N
1  R15 IO_L49P_M1DQ10_1			ADC DQd2 P
1  R16 IO_L49N_M1DQ11_1			ADC DQd2 N
1  R14 IO_L50P_M1UDQS_1			ADC DQd1 P
1  T15 IO_L50N_M1UDQSN_1		ADC DQd1 N
1  T14 IO_L51P_M1DQ12_1			ADC DQd0 P (inverted)
1  T13 IO_L51N_M1DQ13_1			ADC DQd0 N (inverted)
1  R12 IO_L52P_M1DQ14_1			Ch 2 BA7046 Hd output (was Ch 1)
1  T12 IO_L52N_M1DQ15_1			Ch 2 BA7046 Vd output
1  L12 IO_L53P_1			ADC DQ1 P
1  L13 IO_L53N_VREF_1			ADC DQ1 N
1  M13 IO_L74P_AWAKE_1			ADC DQ2 P
1  M14 IO_L74N_DOUT_BUSY_1		ADC DQ2 N
